		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "cicdtuevpoc3",
									"targetURL": "#cicdtuevpoc2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cicdtuevpoc2-display": {
								"semanticObject": "cicdtuevpoc2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cicdtuevpoc2",
									"url": sap.ui.require.toUrl("cicdtuevpoc2")
								}
							}
						}
					}
